"""
MODEL 5: GRADIENT BOOSTING (XGBoost or GradientBoosting)
...
try:
    ...
    USE_XGBOOST = True
    print("=" * 80)
    print("MODEL 5: GRADIENT BOOSTING (XGBoost)")
    print("=" * 80)
except ImportError:
...
MODEL_PATH = os.path.join(BASE_DIR, "..", "models", "model5_gradient_boosting.pkl")
VECTORIZER_PATH = os.path.join(BASE_DIR, "..", "models", "model5_vectorizer.pkl")
...
print("\n[STEP 8/9] Training Gradient Boosting model...")
print("   This will take several minutes (slowest model)...")
...
model_name = "Gradient Boosting (XGBoost)" if USE_XGBOOST else "Gradient Boosting (Sklearn)"
