"""
MODEL 1: RANDOM FOREST WITH TF-IDF (IMPROVED & BALANCED)
...
print("=" * 80)
print("MODEL 1: RANDOM FOREST CLASSIFIER (TF-IDF)")
print("=" * 80)
...
MODEL_PATH = os.path.join(BASE_DIR, "..", "models", "model1_rf_tfidf.pkl")
VECTORIZER_PATH = os.path.join(BASE_DIR, "..", "models", "model1_vectorizer.pkl")
...
if not os.path.exists(DATA_PATH):
    ...
    print(f"   Please make sure urldata.csv is in the dataset folder")
    exit(1)
...
print("\n[STEP 8/9] Training Random Forest model...")
...
print("=" * 80)
print(f"Model: Random Forest (TF-IDF)")
print(f"\nTRAIN SET:")
