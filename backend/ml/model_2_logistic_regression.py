...
MODEL_PATH = os.path.join(BASE_DIR, "..", "models", "model2_logistic_regression.pkl")
VECTORIZER_PATH = os.path.join(BASE_DIR, "..", "models", "model2_vectorizer.pkl")
...
print("\n[STEP 8/9] Training Logistic Regression model...")
